...
def sentence2pronunciaton_lookup(sentence: str, trim_symbols: Set[str], split_on_hyphen: bool, lookup: Union[str, Tuple[str, ...]], consider_annotation: bool, annotation_split_symbol: Optional[str] = "/", use_cache: bool = True, ignore_case_in_cache: Optional[bool] = True) -> Pronunciation:
  pronunciation = sentence2pronunciaton(
